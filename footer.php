        ...
        <div class="col-lg-5 col-md-5">
          <div class="footer-side-list">
            ...
            <ul>
              ...
              <li>
                <i class="fa-solid fa-location-dot" class="addrs"></i>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-3">
          <div class="footer-logo">
            <img src="<?php bloginfo('template_directory'); ?>/assets/img/footer-logo.png" alt="Footer Logo" />
          </div>
        </div>
        <div class="col-lg-8 col-md-9">
          <div class="bottom-text">
            <p>
              ...
              <a href="designlyworld.com" target="_blank">designlyworld</a>
            </p>
            <ul class="social-bottom">
              <li>
                <a href="https://www.linkedin.com/company/jsprinters/" target="_blank"><i
                    class="fa-brands fa-linkedin-in"></i></a>
              </li>
              <li>
                <a href="https://www.facebook.com/profile.php?id=100082232964382" target="_blank"><i
                    class="fa-brands fa-facebook-f"></i></a>
              </li>
              <li>
                <a href="https://www.instagram.com/js_printers/" target="_blank"><i
