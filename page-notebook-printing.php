    ...
    <div class="row" style="float: right;padding-right: 60px;">
        <div class="">
            <div class="select_option mb-0">
                <div class="nice-select" tabindex="0"><span class="current">Notebook</span>
                    <ul class="list">
                        <li data-value="1" class="option"><a href="https://designlyworld.com/identity/">Shirt box </a>
                        </li>
                        ...
                        <li data-value="5" class="option"><a href="https://designlyworld.com/social-ads/">Brochure</a>
                        </li>
                        <li data-value="6" class="option"><a href="https://designlyworld.com/social-ads/">Visting
                                Card</a></li>
                    </ul>
                </div>
            </div>
...
<div class="gallerycontainer">
    <div class="gallery-item">
        <?php if( have_rows('notebook','options') ):?>
        <?php while( have_rows('notebook','options') ) : the_row();
