 ...
 <div class="home-slider owl-carousel owl-theme">
    ...
    <section class="product-area pt-70 pb-70">
      ...
      <div class="product-shape">
        <img src="<?php bloginfo('template_directory'); ?>/assets/img/products/shape.png" alt="Products Shape" />
      </div>
    </section>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-lg-5">
                <div class="testimonial-img-2">
                  <img
                    src="<?php bloginfo('template_directory'); ?>/assets/img/testimonial/2.jpg"
          ...
          <div class="testimonial-card">
            <div class="row align-items-center">
              ...
              <div class="col-lg-5">
                <div class="testimonial-img-2">
                  <img
                    src="<?php bloginfo('template_directory'); ?>/assets/img/testimonial/4.jpg"
                    alt="Testimonial Images"
                  />
                </div>
              </div>
          ...
          <div class="testimonial-card">
            <div class="row align-items-center">
              ...
              <div class="col-lg-5">
                <div class="testimonial-img-2">
                  <img
                    src="<?php bloginfo('template_directory'); ?>/assets/img/testimonial/3.jpg"
                    alt="Testimonial Images"
                  />
                </div>
              </div>
