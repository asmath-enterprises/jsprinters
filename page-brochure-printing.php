            ...
            <div class="select_option mb-0">
                <div class="nice-select" tabindex="0"><span class="current">Brochure</span>
                    <ul class="list">
                        ...
                        <li data-value="2" class="option"><a href="https://designlyworld.com/packaging/">Sweet Box</a>
                        </li>
                        <li data-value="3" class="option"><a
                                href="https://designlyworld.com/brochure-catalogue/">Inner Box</a></li>

                        <li data-value="4" class="option"><a href="https://designlyworld.com/social-ads/">Tag</a>
                        </li>
